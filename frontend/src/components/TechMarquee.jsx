  ...
  return (
    <section className="relative py-10 border-y border-[rgba(176,38,255,0.18)] overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 lg:px-8 mb-6">
        <p className="text-xs uppercase tracking-[0.3em] text-muted-foreground">Tecnologias que utilizamos</p>
      </div>
        ...
        <div className="flex w-max animate-marquee gap-5">
          {row.map((t, i) => (
            <div
              ...
              className="glass rounded-full px-7 py-3 font-display text-lg font-medium text-white/90 whitespace-nowrap hover:text-secondary hover:border-[rgba(214,70,255,0.6)] transition-colors duration-300"
            >
              {t}
            </div>
          ))}
