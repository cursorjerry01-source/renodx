            ...
            <Reveal key={p.title} dir="up" delay={i * 0.06}>
              ...
              >
                <img
                  ...
                  className="absolute inset-0 h-full w-full object-cover object-top opacity-60 transition-transform duration-500 group-hover:scale-110 group-hover:opacity-80"
                />
